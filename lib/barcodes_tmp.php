...
/*					"A7,260,0,2,1,1,N,\"".iconv('UTF-8','CP866//IGNORE','Страна происхождения: Россия')."\"\n".
					...
					"A7,340,0,2,1,1,N,\"".iconv('UTF-8','CP866//IGNORE','п.Октябрьский, ул.Ленина, д.47')."\"\n".
					"A7,360,0,2,1,1,N,\"".iconv('UTF-8','CP866//IGNORE','Производитель: http://www.dveri.ru/')."\"\n".
					"A7,380,0,2,1,1,N,\"".iconv('UTF-8','CP866//IGNORE','182100, г. Великие Луки, пр. Гагарина')."\"\n".
					"A7,400,0,2,1,1,N,\"".iconv('UTF-8','CP866//IGNORE','д. 127А')."\"\n".
